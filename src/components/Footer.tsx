          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-zinc-400 leading-snug">30 N Gould St #55212,<br />Sheridan, WY 82801, USA</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`mailto:${process.env.NEXT_PUBLIC_ADMIN_EMAIL || "admin@kareembaksh.com"}`} className="hover:text-white transition-colors">{process.env.NEXT_PUBLIC_ADMIN_EMAIL || "admin@kareembaksh.com"}</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-rose-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
