...
function ProductsContent({ initialProducts, allCategories }: ProductsContentProps) {
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col gap-6 mb-8">
          ...
          {/* Sort & Count */}
          <div className="flex flex-row items-center justify-between border-t border-zinc-100 pt-4">
            <span className="text-sm font-medium text-zinc-500">{sorted.length} products</span>
...
export default function ProductsClientShell({ initialProducts, allCategories }: ProductsContentProps) {
  return (
    <Suspense fallback={<div className="py-24 text-center text-zinc-400">Loading products...</div>}>
      <ProductsContent initialProducts={initialProducts} allCategories={allCategories} />
    </Suspense>
  );
}
